...
![blocksdesign out put](images/Rplots/block-design-visualization.png){fig-align="center" width=70%}
...
![A v.s. Iteration (Random search)](images/Rplots/random selection example.png){fig-align="center" width=70%}

![Random search out put design](images/Rplots/Random search design visualization.png){fig-align="center" width=70%}
...
![A v.s. Iteration (SA with log cooling schedule)](images/Rplots/SA_SLOW example.png){fig-align="center" width=70%}

![SA with log cooling schedule out put design](images/Rplots/SA_SLOW visualization.png){fig-align="center" width=70%}
...
![A v.s. Iteration (SA with exp cooling schedule)](images/Rplots/SA_F example.png){fig-align="center" width=70%}

![A v.s. Iteration (SA with exp cooling schedule)](images/Rplots/SA_F visualization.png){fig-align="center" width=70%}
...
![#rows v.s. runtime (random selection)](images/Rplots/RS_eva/RS-iternum-distribution.png){fig-align="center" width=70%}
...
![#rows v.s. runtime (random selection)](images/Rplots/RS_eva/RS-row-vs-runtime.png){fig-align="center" width=70%}
...
![#treatment v.s. runtime (random selection)](images/Rplots/RS_eva/RS-trt-vs-runtime.png){fig-align="center" width=70%}
...
![Iteration number distribution (SA with log cooling schedule)](images/Rplots/SA-Slow-eva/SA-Slow-iternum-distribution.png){fig-align="center" width=70%}
...
![#rows v.s. difference (SA with exp cooling schedule)](images/Rplots/SA-Slow-eva/SA-Slow-row-vs-diff.png){fig-align="center" width=70%}
...
![#treatment v.s. difference (SA with exp cooling schedule)](images/Rplots/SA-Slow-eva/SA-Slow-trt-vs-diff.png){fig-align="center" width=70%}
...
![#rows v.s. runtime (random selection)](images/Rplots/SA-Fast-eva/SA-Fast-iternum-distribution.png){fig-align="center" width=70%}
...
![#rows v.s. runtime (random selection)](images/Rplots/SA-Fast-eva/SA-Fast-row-vs-runtime.png){fig-align="center" width=70%}
...
![#rows v.s. runtime (random selection)](images/Rplots/SA-Fast-eva/SA-Fast-trt-vs-runtime.png){fig-align="center" width=70%}
...
![#rows v.s. difference)](images/Rplots/means/r-vs-D.png){fig-align="center" width=70%}

![#rows v.s. difference)](images/Rplots/means/c-vs-D.png){fig-align="center" width=70%}

![#rows v.s. difference)](images/Rplots/means/trt-vs-D.png){fig-align="center" width=70%}
...
![#rows v.s. difference)](images/Rplots/means/trt-vs-ABS-D.png){fig-align="center" width=70%}
...
![#rows v.s. difference)](images/Rplots/means/r-vs-t.png){fig-align="center" width=70%}

![#rows v.s. difference)](images/Rplots/means/c-vs-t.png){fig-align="center" width=70%}

![#rows v.s. difference)](images/Rplots/means/trt-vs-t.png){fig-align="center" width=70%}
