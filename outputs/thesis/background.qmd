...
And we have $\boldsymbol{\tau}\sim N(\hat{\boldsymbol{\tau}},\boldsymbol{C}_{\text{Fisher}}^{-1})$.We will provide the specific form of this matrix and the related proof in the introduction of the A-value.
