...
#| fig-cap: "Detailed assignment for treatments given by design function in blocksdesign package "
#| warning: false
...
```{r}
#| label: fig-RvD
#| fig-cap: "The above plot shows the average relative difference between $A_{op}$ and $A_{result}$ by the number of rows for different algorithms, with the lines representing different algorithms."
#| warning: false
...
```{r}
#| label: fig-CvD
#| fig-cap: "The above plot shows the average relative difference between $A_{op}$ and $A_{result}$ by the number of columns for different algorithms, with the lines representing different algorithms."
#| warning: false
...
results |>
  ...
  geom_smooth(se = FALSE, method = "loess",span = 0.2) +
  scale_color_manual(values = c("SA exp Cooling" = "blue", "SA log Cooling" = "green", "Random Selection" = "red")) + 
  labs(x = "Number of columns", y = "Average relative error", color = "Algorithm") 
```


```{r}
#| label: fig-TvD
#| fig-cap: "The above plot shows the average relative difference between $A_{op}$ and $A_{result} by the number of treatments for different algorithms, with the lines representing different algorithms."
#| warning: false
...
```{r}
#| label: fig-RvT
#| fig-cap: "The above plot shows the average runtime by the number of rows for different algorithms, with the lines representing different algorithms."
#| warning: false
...
```{r}
#| label: fig-CvT
#| fig-cap: "The above plot shows the average runtime by the number of columns for different algorithms, with the lines representing different algorithms."
#| warning: false
...
```{r}
#| label: fig-TvT
#| fig-cap: "The above plot shows the average runtime by the number of treatments for different algorithms, with the lines representing different algorithms."
#| warning: false
