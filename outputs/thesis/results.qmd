...
::: {#fig-align style="text-align: center"}
![blocksdesign out put](../thesis/images/Rplots/block-design-visualization.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![A v.s. Iteration (Random search)](../thesis/images/Rplots/random selection example.png){fig-align="center" width=70%}
:::

::: {#fig-align style="text-align: center"}
![Random search out put design](../thesis/images/Rplots/Random search design visualization.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![A v.s. Iteration (SA with log cooling schedule)](D:/Mater Advanced project/Master project/outputs/Rplots/SA_SLOW example.png){fig-align="center" width=70%}
:::

::: {#fig-align style="text-align: center"}
![SA with log cooling schedule out put design](../thesis/images/Rplots/SA_SLOW visualization.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![A v.s. Iteration (SA with exp cooling schedule)](../thesis/images/Rplots/SA_F example.png){fig-align="center" width=70%}
:::

::: {#fig-align style="text-align: center"}
![A v.s. Iteration (SA with exp cooling schedule)](../thesis/images/Rplots/SA_F visualization.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![#rows v.s. runtime (random selection)](../thesis/images/Rplots/RS_eva/RS-iternum-distribution.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![#rows v.s. runtime (random selection)](../thesis/images/Rplots/RS_eva/RS-row-vs-runtime.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![#treatment v.s. runtime (random selection)](../thesis/images/Rplots/RS_eva/RS-trt-vs-runtime.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![Iteration number distribution (SA with log cooling schedule)](../thesis/images/Rplots/SA-Slow-eva/SA-Slow-iternum-distribution.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![#rows v.s. difference (SA with exp cooling schedule)](../thesis/images/Rplots/SA-Slow-eva/SA-Slow-row-vs-diff.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![#treatment v.s. difference (SA with exp cooling schedule)](../thesis/images/Rplots/SA-Slow-eva/SA-Slow-trt-vs-diff.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![#rows v.s. runtime (random selection)](../thesis/images/Rplots/SA-Fast-eva/SA-Fast-iternum-distribution.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![#rows v.s. runtime (random selection)](../thesis/images/Rplots/SA-Fast-eva/SA-Fast-row-vs-runtime.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![#rows v.s. runtime (random selection)](../thesis/images/Rplots/SA-Fast-eva/SA-Fast-trt-vs-runtime.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![#rows v.s. difference)](../thesis/images/Rplots/means/r-vs-D.png){fig-align="center" width=70%}
:::

::: {#fig-align style="text-align: center"}
![#rows v.s. difference)](../thesis/images/Rplots/means/c-vs-D.png){fig-align="center" width=70%}
:::

::: {#fig-align style="text-align: center"}
![#rows v.s. difference)](../thesis/images/Rplots/means/trt-vs-D.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![#rows v.s. difference)](../thesis/images/Rplots/means/trt-vs-ABS-D.png){fig-align="center" width=70%}
:::
...
::: {#fig-align style="text-align: center"}
![#rows v.s. difference)](../thesis/images/Rplots/means/r-vs-t.png){fig-align="center" width=70%}
:::

::: {#fig-align style="text-align: center"}
![#rows v.s. difference)](../thesis/images/Rplots/means/c-vs-t.png){fig-align="center" width=70%}
:::

::: {#fig-align style="text-align: center"}
![#rows v.s. difference)](../thesis/images/Rplots/means/trt-vs-t.png){fig-align="center" width=70%}
:::
